...
def AfricaMap(continental=False, year=2018, immutable=False):
    ...
    return Graph(common_border, format='dict_of_lists', name=name, immutable=immutable)
...
def EuropeMap(continental=False, year=2018, immutable=False):
    ...
    common_border = {
        ...
        'Hungary': ['Austria', 'Romania', 'Serbia', 'Slovakia', 'Slovenia', 'Ukraine'],
        'Ireland': ['United Kingdom'],
        'Italy': ['Austria', 'San Marino', 'Slovenia', 'Switzerland', 'Vatican City'],
