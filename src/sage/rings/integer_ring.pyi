...
class IntegerRing_class(Ring):
    ...
    def range(
        self, start: Any, end: Optional[Any] = None, step: Optional[Any] = None
    ) -> list[Integer]: ...
    ...
    def _is_valid_homomorphism_(
        self, codomain: Any, im_gens: list[Any], base_map: Optional[Any] = None
    ) -> bool: ...
    ...
    def residue_field(
        self, prime: Any, check: bool = True, names: Optional[Any] = None
    ) -> Any: ...
    ...
    ) -> list[Union[tuple[Integer, int], Integer]]: ...
    ...
    def from_bytes(
        self, input_bytes: Any, byteorder: str = 'big', is_signed: bool = False
    ) -> Integer: ...
