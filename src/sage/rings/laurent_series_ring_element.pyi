...
class LaurentSeriesRingElement:
    ...
    def _im_gens_(
        self, codomain: Any, im_gens: builtins.list[Any], base_map: Any | None = None
    ) -> LaurentSeriesRingElement: ...
    ...
    def revert(self, precision: int | None = None) -> LaurentSeriesRingElement: ...
    def reverse(self, precision: int | None = None) -> LaurentSeriesRingElement: ...

    compositional_inverse = revert

    def derivative(self, *args: Any) -> LaurentSeriesRingElement: ...
    def _derivative(self, var: Any | None = None) -> LaurentSeriesRingElement: ...
    def integral(self) -> LaurentSeriesRingElement: ...
    def nth_root(self, n: int, prec: int | None = None) -> LaurentSeriesRingElement: ...
    ...
    def map_coefficients(
        self, f: Any, new_base_ring: Any = None
    ) -> LaurentSeriesRingElement: ...
