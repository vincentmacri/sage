...
def ComplexIntervalFieldElement_to_acb(
    target: acb_t, source: ComplexIntervalFieldElement
) -> None: ...
def acb_to_ComplexIntervalFieldElement(
    target: ComplexIntervalFieldElement, source: acb_t
) -> int: ...
