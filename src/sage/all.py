...
warnings.filterwarnings(
    'ignore', category=DeprecationWarning, module='(scipy|networkx)'
)
...
warnings.filterwarnings(
    'ignore', category=DeprecationWarning, module='(.*[.]_vendor[.])?packaging'
)
...
from cysignals.signals import AlarmInterrupt, SignalError, sig_on_reset as sig_on_count
...
register_unpickle_override(
    'sage.categories.category_types', 'HeckeModules', HeckeModules
)
...
register_unpickle_override(
    'sage.categories.category_types', 'VectorSpaces', VectorSpaces
)
register_unpickle_override(
...
register_unpickle_override(
    'sage.categories.category_types', 'ModularAbelianVarieties', ModularAbelianVarieties
)
