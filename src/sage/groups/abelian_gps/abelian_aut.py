...
class AbelianGroupAutomorphismGroup_gap(
    CachedRepresentation, GroupMixinLibGAP, Group, ParentLibGAP
):
    r"""
...
class AbelianGroupAutomorphismGroup(AbelianGroupAutomorphismGroup_gap):
    ...
    def __init__(self, AbelianGroupGap):
        ...
        AbelianGroupAutomorphismGroup_gap.__init__(
            self, self._domain, gap_group=G, category=category, ambient=None
        )
...
class AbelianGroupAutomorphismGroup_subgroup(AbelianGroupAutomorphismGroup_gap):
    ...
    def __init__(self, ambient, generators):
        ...
        category = Groups().Finite().Enumerated()
        AbelianGroupAutomorphismGroup_gap.__init__(
            self, self._domain, gap_group=H, category=category, ambient=ambient
        )
