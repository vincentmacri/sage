...
lazy_import(
    'sage.combinat.designs.steiner_quadruple_systems', 'steiner_quadruple_system'
)
...
lazy_import('sage.combinat.designs.latin_squares', 'mutually_orthogonal_latin_squares')
...
lazy_import(
    ...
    ('resolvable_balanced_incomplete_block_design', 'kirkman_triple_system'),
)
lazy_import('sage.combinat.designs.group_divisible_designs', 'group_divisible_design')

lazy_import(
    'sage.combinat.designs.orthogonal_arrays',
    'OAMainFunctions',
    as_='orthogonal_arrays',
)
