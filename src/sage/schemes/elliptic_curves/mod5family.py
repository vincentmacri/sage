...
def mod5family(a, b):
    ...
    alpha[14] = (
        2280
        * (J - 1) ** 7
        * (221 + 13832 * J - 103792 * J**2 + 554112 * J**3 - 373248 * J**4)
    )
    alpha[15] = (
        1824
        * (J - 1) ** 8
        * (-119 - 9842 * J + 92608 * J**2 - 911520 * J**3 + 373248 * J**4)
    )
    alpha[16] = (
        4275
        * (J - 1) ** 8
        * (-17 - 1792 * J + 23264 * J**2 - 378368 * J**3 + 338688 * J**4)
    )
    alpha[17] = (
        18240 * (J - 1) ** 9 * (1 + 133 * J - 2132 * J**2 + 54000 * J**3 - 15552 * J**4)
    )
    alpha[18] = (
        190
        * (J - 1) ** 9
    ...
    beta[16] = (
        145422675
        * (J - 1) ** 8
        * (1 + 288 * J + 288 * J**2 + 5120 * J**3 - 6912 * J**4)
    )
    beta[17] = (
        17108550
        * (J - 1) ** 8
        * (7 + 2504 * J + 3584 * J**2 + 93184 * J**3 - 283392 * J**4 + 165888 * J**5)
    )
    beta[18] = (
        950475
        * (J - 1) ** 9
