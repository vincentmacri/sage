...
class DefaultConvertMap:
    def __init__(
        self, domain: Any, codomain: Any, category: Optional[Any] = None
    ) -> None: ...
...
class CallableConvertMap:
    def __init__(
        ...
        codomain: Any,
        func: Callable,
        parent_as_first_arg: Optional[bool] = None,
    ) -> None: ...
    def _extra_slots(self) -> dict[str, Any]: ...
    def _update_slots(self, _slots: dict[str, Any]) -> None: ...
    def _call_(self, x: Any) -> Any: ...
...
def CCallableConvertMap(
    domain: Any, codomain: Any, func: Any, name: Optional[str]
) -> CCallableConvertMap_class: ...
def _ccall_test_function(codomain: Any, x: Any) -> Any: ...
def test_CCallableConvertMap(
    domain: Any, name: Optional[str] = None
) -> CCallableConvertMap_class: ...
