...
def detect_element_action(
    X: Any,
    Y: Any,
    X_on_left: bool,
    X_el: Optional[Any] = None,
    Y_el: Optional[Any] = None,
) -> Optional[Any]: ...
...
class IntegerMulAction(IntegerAction):
    def __init__(
        self, Z: Any, M: Any, is_left: bool = True, m: Optional[Any] = None
    ) -> None: ...
...
class IntegerPowAction(IntegerAction):
    def __init__(
        self, Z: Any, M: Any, is_left: bool = False, m: Optional[Any] = None
    ) -> None: ...
