...
`./matrix_gap.pyx:351:    cdef Matrix _matrix_times_matrix_(self, Matrix right):`
...
`./matrix_modn_dense_template.pxi:1045:    cdef _matrix_times_matrix_(self, Matrix right):`
