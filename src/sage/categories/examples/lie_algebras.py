...
class LieAlgebraFromAssociative(Parent, UniqueRepresentation):
    ...
    def _repr_(self):
        ...
        """
        return (
            "An example of a Lie algebra: the Lie algebra from the"
            " associative algebra {} generated by {}".format(self._A, self._gens)
        )
    ...
    class Element(ElementWrapper):
        ...
        def _bracket_(self, rhs):
            ...
            return self.__class__(
                self.parent(), self.value * rhs.value - rhs.value * self.value
            )
