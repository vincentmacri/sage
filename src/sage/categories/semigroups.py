...
class Semigroups(CategoryWithAxiom):
    ...
    class ParentMethods:
        ...
        def subsemigroup(self, generators, one=None, category=None):
            ...
            return AutomaticSemigroup(
                generators, ambient=self, one=one, category=category
            )
        ...
        def _pow_int(self, n):
            ...
            if n <= 0:
                raise ArithmeticError(
                    "only positive powers are supported in a semigroup"
                )
    ...
    Finite = LazyImport(
        'sage.categories.finite_semigroups', 'FiniteSemigroups', at_startup=True
    )
        ...
        class ParentMethods:
            ...
            def representation(self, module, on_basis, side='left', *args, **kwargs):
                ...
                return Representation(
                    self.group(), module, on_basis, side, *args, **kwargs
                )
