...
#define __PYX_HAVE__sage__ext__memory
#define __PYX_HAVE_API__sage__ext__memory
/* Early includes */
#include <string.h>
#include <stdlib.h>
#include <stdio.h>
...
/* Module declarations from "sage.libs.gmp.misc" */

/* Module declarations from "sage.ext.memory" */
static void __pyx_f_4sage_3ext_6memory_alloc_error(size_t); /*proto*/
static void *__pyx_f_4sage_3ext_6memory_sage_sig_malloc(size_t); /*proto*/
static void *__pyx_f_4sage_3ext_6memory_sage_sig_realloc(void *, size_t, size_t); /*proto*/
static void __pyx_f_4sage_3ext_6memory_sage_sig_free(void *, size_t); /*proto*/
/* #### Code section: typeinfo ### */
/* #### Code section: before_global_var ### */
#define __Pyx_MODULE_NAME "sage.ext.memory"
extern int __pyx_module_is_main_sage__ext__memory;
int __pyx_module_is_main_sage__ext__memory = 0;

/* Implementation of "sage.ext.memory" */
/* #### Code section: global_var ### */
static PyObject *__pyx_builtin_MemoryError;
/* #### Code section: string_decls ### */
static const char __pyx_k_[] = " * ";
static const char __pyx_k__2[] = "?";
static const char __pyx_k_1_q[] = "\200\001\360\022\000\005\034\2301\320\034-\320-?\270q";
...
static const char __pyx_k_sage_ext_memory_pyx[] = "sage/ext/memory.pyx";
...
#define __pyx_kp_u_bytes __pyx_string_tab[4]
#define __pyx_n_u_cline_in_traceback __pyx_string_tab[5]
#define __pyx_kp_u_failed_to_allocate __pyx_string_tab[6]
#define __pyx_kp_u_failed_to_allocate_s_bytes __pyx_string_tab[7]
#define __pyx_n_u_func __pyx_string_tab[8]
#define __pyx_n_u_init_memory_functions __pyx_string_tab[9]
...
#define __pyx_n_u_sage_ext_memory __pyx_string_tab[15]
#define __pyx_kp_u_sage_ext_memory_pyx __pyx_string_tab[16]
...
static void __pyx_f_4sage_3ext_6memory_alloc_error(size_t __pyx_v_size) {

  /* "sage/ext/memory.pyx":49
 *     Jump back to ``sig_on()``, raising a :exc:`MemoryError`.
 *     """
 *     with gil:             # <<<<<<<<<<<<<<
 ...
 * 
*/
        PyErr_Format(__pyx_builtin_MemoryError, ((char *)"failed to allocate %zu bytes"), __pyx_v_size);
      }
...
static void *__pyx_f_4sage_3ext_6memory_sage_sig_malloc(size_t __pyx_v_size) {
  void *__pyx_v_p;
  void *__pyx_r;
  int __pyx_t_1;

  /* "sage/ext/memory.pyx":60
 ...
 *         alloc_error(size)
*/
  __pyx_v_p = sig_malloc(__pyx_v_size);

  /* "sage/ext/memory.pyx":61
 *     """
 *     cdef void* p = sig_malloc(size)
 *     if unlikely(p == NULL):             # <<<<<<<<<<<<<<
 *         alloc_error(size)
 *     return p
*/
  __pyx_t_1 = (unlikely((__pyx_v_p == NULL)) != 0);
  if (__pyx_t_1) {

    /* "sage/ext/memory.pyx":62
 *     cdef void* p = sig_malloc(size)
 *     if unlikely(p == NULL):
 *         alloc_error(size)             # <<<<<<<<<<<<<<
 *     return p
 * 
*/
    __pyx_f_4sage_3ext_6memory_alloc_error(__pyx_v_size);
...
static void *__pyx_f_4sage_3ext_6memory_sage_sig_realloc(void *__pyx_v_ptr, CYTHON_UNUSED size_t __pyx_v_old_size, size_t __pyx_v_new_size) {
  void *__pyx_v_p;
  void *__pyx_r;
  int __pyx_t_1;

  /* "sage/ext/memory.pyx":72
 *     Out-of-memory errors are handled using the ``sig_error`` mechanism.
 *     """
...
*/
  __pyx_v_p = sig_realloc(__pyx_v_ptr, __pyx_v_new_size);

  /* "sage/ext/memory.pyx":73
 *     """
 *     cdef void* p = sig_realloc(ptr, new_size)
 *     if unlikely(p == NULL):             # <<<<<<<<<<<<<<
 *         alloc_error(new_size)
 ...
 * 
*/
    __pyx_f_4sage_3ext_6memory_alloc_error(__pyx_v_new_size);
...
static void __pyx_f_4sage_3ext_6memory_sage_sig_free(void *__pyx_v_ptr, CYTHON_UNUSED size_t __pyx_v_size) {

  /* "sage/ext/memory.pyx":82
 *     ``free()`` function for the MPIR/GMP library.
 *     """
 *     sig_free(ptr)             # <<<<<<<<<<<<<<
 * 
...
/* Python wrapper */
static PyObject *__pyx_pw_4sage_3ext_6memory_1init_memory_functions(PyObject *__pyx_self, CYTHON_UNUSED PyObject *unused); /*proto*/
PyDoc_STRVAR(__pyx_doc_4sage_3ext_6memory_init_memory_functions, "init_memory_functions()\n\nFile: /home/vince/Documents/git/sage/src/sage/ext/memory.pyx (starting at line 85)\n\nSet the MPIR/GMP memory functions to the above functions.\n\nEXAMPLES::\n\n    sage: from sage.ext.memory import init_memory_functions\n    sage: init_memory_functions()");
static PyMethodDef __pyx_mdef_4sage_3ext_6memory_1init_memory_functions = {"init_memory_functions", (PyCFunction)__pyx_pw_4sage_3ext_6memory_1init_memory_functions, METH_NOARGS, __pyx_doc_4sage_3ext_6memory_init_memory_functions};
static PyObject *__pyx_pw_4sage_3ext_6memory_1init_memory_functions(PyObject *__pyx_self, CYTHON_UNUSED PyObject *unused) {
  CYTHON_UNUSED PyObject *const *__pyx_kwvalues;
  PyObject *__pyx_r = 0;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("init_memory_functions (wrapper)", 0);
  __pyx_kwvalues = __Pyx_KwValues_VARARGS(__pyx_args, __pyx_nargs);
  __pyx_r = __pyx_pf_4sage_3ext_6memory_init_memory_functions(__pyx_self);
...
static PyObject *__pyx_pf_4sage_3ext_6memory_init_memory_functions(CYTHON_UNUSED PyObject *__pyx_self) {
  PyObject *__pyx_r = NULL;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("init_memory_functions", 0);

  /* "sage/ext/memory.pyx":94
 *         sage: init_memory_functions()
 *     """
 ...
 * 
*/
  mp_set_memory_functions(__pyx_f_4sage_3ext_6memory_sage_sig_malloc, __pyx_f_4sage_3ext_6memory_sage_sig_realloc, __pyx_f_4sage_3ext_6memory_sage_sig_free);
...
__Pyx_RefNannySetupContext("PyInit_memory", 0);
  ...
  if (__pyx_module_is_main_sage__ext__memory) {
    if (PyObject_SetAttr(__pyx_m, __pyx_mstate_global->__pyx_n_u_name, __pyx_mstate_global->__pyx_n_u_main) < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "sage.ext.memory")) {
      if (unlikely((PyDict_SetItemString(modules, "sage.ext.memory", __pyx_m) < 0))) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  /*--- Builtin init code ---*/
 ...
 *     Set the MPIR/GMP memory functions to the above functions.
*/
  __pyx_t_2 = __Pyx_CyFunction_New(&__pyx_mdef_4sage_3ext_6memory_1init_memory_functions, 0, __pyx_mstate_global->__pyx_n_u_init_memory_functions, NULL, __pyx_mstate_global->__pyx_n_u_sage_ext_memory, __pyx_mstate_global->__pyx_d, ((PyObject *)__pyx_mstate_global->__pyx_codeobj_tab[0])); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 85, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  if (PyDict_SetItem(__pyx_mstate_global->__pyx_d, __pyx_mstate_global->__pyx_n_u_init_memory_functions, __pyx_t_2) < 0) __PYX_ERR(0, 85, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;

  /* "sage/ext/memory.pyx":97
 * 
 * 
 * init_memory_functions()             # <<<<<<<<<<<<<<
*/
  __pyx_t_3 = NULL;
  __Pyx_GetModuleGlobalName(__pyx_t_4, __pyx_mstate_global->__pyx_n_u_init_memory_functions); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 97, __pyx_L1_error)
  ...
  if (__pyx_m) {
    if (__pyx_mstate->__pyx_d && stringtab_initialized) {
      __Pyx_AddTraceback("init sage.ext.memory", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    #if !CYTHON_USE_MODULE_STATE
    Py_CLEAR(__pyx_m);
    #else
    ...
    PyErr_SetString(PyExc_ImportError, "init sage.ext.memory");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if CYTHON_PEP489_MULTI_PHASE_INIT
...
static const __Pyx_StringTabEntry __pyx_string_tab[] = {
  ...
  {__pyx_k_init_memory_functions, sizeof(__pyx_k_init_memory_functions), 0, 1, 1}, /* PyObject cname: __pyx_n_u_init_memory_functions */
  {__pyx_k_is_coroutine, sizeof(__pyx_k_is_coroutine), 0, 1, 1}, /* PyObject cname: __pyx_n_u_is_coroutine */
  {__pyx_k_main, sizeof(__pyx_k_main), 0, 1, 1}, /* PyObject cname: __pyx_n_u_main */
  {__pyx_k_module, sizeof(__pyx_k_module), 0, 1, 1}, /* PyObject cname: __pyx_n_u_module */
  {__pyx_k_name, sizeof(__pyx_k_name), 0, 1, 1}, /* PyObject cname: __pyx_n_u_name */
  {__pyx_k_qualname, sizeof(__pyx_k_qualname), 0, 1, 1}, /* PyObject cname: __pyx_n_u_qualname */
  {__pyx_k_sage_ext_memory, sizeof(__pyx_k_sage_ext_memory), 0, 1, 1}, /* PyObject cname: __pyx_n_u_sage_ext_memory */
  {__pyx_k_sage_ext_memory_pyx, sizeof(__pyx_k_sage_ext_memory_pyx), 0, 1, 0}, /* PyObject cname: __pyx_kp_u_sage_ext_memory_pyx */
...
static int __Pyx_CreateCodeObjects(__pyx_mstatetype *__pyx_mstate) {
  ...
  {
    const __Pyx_PyCode_New_function_description descr = {0, 0, 0, 0, (unsigned int)(CO_OPTIMIZED|CO_NEWLOCALS), 85, 17};
    PyObject* const varnames[] = {0};
    __pyx_mstate_global->__pyx_codeobj_tab[0] = __Pyx_PyCode_New(descr, varnames, __pyx_mstate->__pyx_kp_u_sage_ext_memory_pyx, __pyx_mstate->__pyx_n_u_init_memory_functions, __pyx_k_1_q, tuple_dedup_map); if (unlikely(!__pyx_mstate_global->__pyx_codeobj_tab[0])) goto bad;
  }
