...
#define __PYX_HAVE__sage__libs__pari__misc
#define __PYX_HAVE_API__sage__libs__pari__misc
/* Early includes */
#include <string.h>
#include <stdio.h>
#include "pari/pari.h"
...
#define __Pyx_MODULE_NAME "sage.libs.pari.misc"
extern int __pyx_module_is_main_sage__libs__pari__misc;
int __pyx_module_is_main_sage__libs__pari__misc = 0;

/* Implementation of "sage.libs.pari.misc" */
...
static const char __pyx_k_File_home_vince_Documents_git_sa[] = "File: /home/vince/Documents/git/sage/src/sage/libs/pari/misc.pyx (starting at line 1)";
...
static struct __pyx_obj_7cypari2_3gen_Gen *__pyx_f_4sage_4libs_4pari_4misc_new_t_POL_from_int_star(int *__pyx_v_vals, unsigned long __pyx_v_length, long __pyx_v_varnum) {
  GEN __pyx_v_z;
 ...
 *     if length == 0:
*/
  __pyx_t_1 = sig_on(); if (unlikely(__pyx_t_1 == ((int)0))) __PYX_ERR(0, 15, __pyx_L1_error)

  /* "sage/libs/pari/misc.pyx":16
 * 
 *     sig_on()
 *     z = cgetg(length + 2, t_POL)             # <<<<<<<<<<<<<<
 *     if length == 0:
...
*/
    (__pyx_v_z[1]) = (evalvarn(__pyx_v_varnum) + evalsigne(0));
...
*/
  /*else*/ {
    (__pyx_v_z[1]) = (evalvarn(__pyx_v_varnum) + evalsigne(1));

    /* "sage/libs/pari/misc.pyx":22
 *     else:
 *         z[1] = evalvarn(varnum) + evalsigne(1)
 *         for i in range(length):             # <<<<<<<<<<<<<<
 *             set_gel(z, i+2, stoi(vals[i]))
 ...
 *     return new_gen(z)
*/
      (void)(set_gel(__pyx_v_z, (__pyx_v_i + 2), stoi((__pyx_v_vals[__pyx_v_i]))));
    }
  }
  __pyx_L3:;

  /* "sage/libs/pari/misc.pyx":25
 *             set_gel(z, i+2, stoi(vals[i]))
 * 
 *     return new_gen(z)             # <<<<<<<<<<<<<<
*/
  __Pyx_XDECREF((PyObject *)__pyx_r);
  __pyx_t_6 = ((PyObject *)__pyx_f_7cypari2_5stack_new_gen(__pyx_v_z)); if (unlikely(!__pyx_t_6)) __PYX_ERR(0, 25, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_6);
  __pyx_r = ((struct __pyx_obj_7cypari2_3gen_Gen *)__pyx_t_6);
  __pyx_t_6 = 0;
  goto __pyx_L0;
...
*/
  ...
  __Pyx_AddTraceback("sage.libs.pari.misc.new_t_POL_from_int_star", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __pyx_r = 0;
  __pyx_L0:;
  __Pyx_XGIVEREF((PyObject *)__pyx_r);
  __Pyx_RefNannyFinishContext();
...
static int __Pyx_modinit_function_export_code(__pyx_mstatetype *__pyx_mstate) {
  ...
  if (__Pyx_ExportFunction("new_t_POL_from_int_star", (void (*)(void))__pyx_f_4sage_4libs_4pari_4misc_new_t_POL_from_int_star, "struct __pyx_obj_7cypari2_3gen_Gen *(int *, unsigned long, long)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  __Pyx_RefNannyFinishContext();
  return 0;
  __pyx_L1_error:;
  __Pyx_RefNannyFinishContext();
...
__Pyx_RefNannySetupContext("PyInit_misc", 0);
  ...
  if (__pyx_module_is_main_sage__libs__pari__misc) {
    if (PyObject_SetAttr(__pyx_m, __pyx_mstate_global->__pyx_n_u_name, __pyx_mstate_global->__pyx_n_u_main) < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "sage.libs.pari.misc")) {
      if (unlikely((PyDict_SetItemString(modules, "sage.libs.pari.misc", __pyx_m) < 0))) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  /*--- Builtin init code ---*/
...
*/
  ...
  if (__pyx_m) {
    if (__pyx_mstate->__pyx_d && stringtab_initialized) {
      __Pyx_AddTraceback("init sage.libs.pari.misc", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    #if !CYTHON_USE_MODULE_STATE
    Py_CLEAR(__pyx_m);
    #else
    ...
    PyErr_SetString(PyExc_ImportError, "init sage.libs.pari.misc");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if CYTHON_PEP489_MULTI_PHASE_INIT
...
static int __Pyx_InitCachedBuiltins(__pyx_mstatetype *__pyx_mstate) {
  CYTHON_UNUSED_VAR(__pyx_mstate);
  __pyx_builtin_range = __Pyx_GetBuiltinName(__pyx_mstate->__pyx_n_u_range); if (!__pyx_builtin_range) __PYX_ERR(0, 22, __pyx_L1_error)
