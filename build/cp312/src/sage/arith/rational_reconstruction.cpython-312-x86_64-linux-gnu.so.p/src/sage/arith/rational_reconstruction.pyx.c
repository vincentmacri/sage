...
#define __PYX_HAVE__sage__arith__rational_reconstruction
#define __PYX_HAVE_API__sage__arith__rational_reconstruction
/* Early includes */
#include <string.h>
#include <stdio.h>
#include "gmp.h"
...
static const char* const __pyx_f[] = {
  "sage/arith/rational_reconstruction.pyx",
  "cpython/type.pxd",
};
...
#define __Pyx_MODULE_NAME "sage.arith.rational_reconstruction"
extern int __pyx_module_is_main_sage__arith__rational_reconstruction;
int __pyx_module_is_main_sage__arith__rational_reconstruction = 0;

/* Implementation of "sage.arith.rational_reconstruction" */
...
static const char __pyx_k_File_home_vince_Documents_git_sa[] = "File: /home/vince/Documents/git/sage/src/sage/arith/rational_reconstruction.pyx (starting at line 1)\n\nRational reconstruction\n\nThis file is a Cython implementation of rational reconstruction, using\ndirect MPIR calls.\n\nAUTHORS:\n\n- \077\077? (2006 or before)\n\n- Jeroen Demeyer (2014-10-20): move this function from ``gmp.pxi``,\n  simplify and fix some bugs, see :issue:`17180`\n";
static const char __pyx_k_rational_reconstruction_does_not[] = "rational reconstruction does not exist";
static const char __pyx_k_rational_reconstruction_with_zer[] = "rational reconstruction with zero modulus";
/* #### Code section: decls ### */
...
#define __pyx_n_u_ZeroDivisionError __pyx_string_tab[2]
...
#define __pyx_kp_u_rational_reconstruction_does_not __pyx_string_tab[8]
#define __pyx_kp_u_rational_reconstruction_with_zer __pyx_string_tab[9]
...
/* "sage/arith/rational_reconstruction.pyx":31
 * 
 * 
...
static int __pyx_f_4sage_5arith_23rational_reconstruction_mpq_rational_reconstruction(__mpq_struct *__pyx_v_answer, __mpz_struct *__pyx_v_a, __mpz_struct *__pyx_v_m) {
  mpz_t __pyx_v_bound;
  mpz_t __pyx_v_u1;
  mpz_t __pyx_v_u2;
  mpz_t __pyx_v_v1;
  ...
  int __pyx_clineno = 0;
  __Pyx_RefNannySetupContext("mpq_rational_reconstruction", 0);

  /* "sage/arith/rational_reconstruction.pyx":59
 *     cdef mpz_t q
 * 
 *     if mpz_sgn(m) == 0:             # <<<<<<<<<<<<<<
 ...
 * 
*/
  __pyx_t_1 = (mpz_sgn(__pyx_v_m) == 0);
  if (unlikely(__pyx_t_1)) {

    /* "sage/arith/rational_reconstruction.pyx":60
 * 
 *     if mpz_sgn(m) == 0:
 *         raise ZeroDivisionError("rational reconstruction with zero modulus")             # <<<<<<<<<<<<<<
 * 
...
*/
    ...
    __pyx_t_5 = 1;
    {
      PyObject *__pyx_callargs[2] = {__pyx_t_3, __pyx_mstate_global->__pyx_kp_u_rational_reconstruction_with_zer};
...
*/
  ...
  /* "sage/arith/rational_reconstruction.pyx":62
 *         raise ZeroDivisionError("rational reconstruction with zero modulus")
 * 
 *     sig_on()             # <<<<<<<<<<<<<<
 *     mpz_init(bound)
...
*/
  __pyx_t_6 = sig_on(); if (unlikely(__pyx_t_6 == ((int)0))) __PYX_ERR(0, 62, __pyx_L1_error)

  /* "sage/arith/rational_reconstruction.pyx":63
 * 
 *     sig_on()
 *     mpz_init(bound)             # <<<<<<<<<<<<<<
 *     mpz_init_set_ui(u1, 0)
...
*/
  mpz_init(__pyx_v_bound);

  /* "sage/arith/rational_reconstruction.pyx":64
 *     sig_on()
 *     mpz_init(bound)
 *     mpz_init_set_ui(u1, 0)             # <<<<<<<<<<<<<<
 *     mpz_init_set_ui(v1, 1)
 *     mpz_init(u2)
*/
  mpz_init_set_ui(__pyx_v_u1, 0);

  /* "sage/arith/rational_reconstruction.pyx":65
 *     mpz_init(bound)
 *     mpz_init_set_ui(u1, 0)
 *     mpz_init_set_ui(v1, 1)             # <<<<<<<<<<<<<<
 *     mpz_init(u2)
 *     mpz_init(v2)
*/
  mpz_init_set_ui(__pyx_v_v1, 1);

  /* "sage/arith/rational_reconstruction.pyx":66
 *     mpz_init_set_ui(u1, 0)
 *     mpz_init_set_ui(v1, 1)
 *     mpz_init(u2)             # <<<<<<<<<<<<<<
 *     mpz_init(v2)
...
*/
  ...
  /* "sage/arith/rational_reconstruction.pyx":67
 *     mpz_init_set_ui(v1, 1)
 *     mpz_init(u2)
 *     mpz_init(v2)             # <<<<<<<<<<<<<<
 *     mpz_init(q)
...
*/
  ...
  /* "sage/arith/rational_reconstruction.pyx":68
 *     mpz_init(u2)
 *     mpz_init(v2)
 *     mpz_init(q)             # <<<<<<<<<<<<<<
 * 
...
*/
  ...
  /* "sage/arith/rational_reconstruction.pyx":70
 *     mpz_init(q)
 * 
 *     try:             # <<<<<<<<<<<<<<
 *         mpz_abs(u2, m)                 # u2 = |m|
...
*/
  /*try:*/ {
    ...
    /* "sage/arith/rational_reconstruction.pyx":71
 * 
 *     try:
 *         mpz_abs(u2, m)                 # u2 = |m|             # <<<<<<<<<<<<<<
 *         mpz_mod(v2, a, u2)             # v2 = a % m
...
*/
    mpz_abs(__pyx_v_u2, __pyx_v_m);

    /* "sage/arith/rational_reconstruction.pyx":72
 *     try:
 *         mpz_abs(u2, m)                 # u2 = |m|
 *         mpz_mod(v2, a, u2)             # v2 = a % m             # <<<<<<<<<<<<<<
 *         mpz_fdiv_q_2exp(bound, u2, 1)
...
*/
    mpz_mod(__pyx_v_v2, __pyx_v_a, __pyx_v_u2);

    /* "sage/arith/rational_reconstruction.pyx":73
 *         mpz_abs(u2, m)                 # u2 = |m|
 *         mpz_mod(v2, a, u2)             # v2 = a % m
 *         mpz_fdiv_q_2exp(bound, u2, 1)             # <<<<<<<<<<<<<<
 *         mpz_sqrtrem(bound, q, bound)   # bound = floor(sqrt(|m|/2))
 * 
*/
    mpz_fdiv_q_2exp(__pyx_v_bound, __pyx_v_u2, 1);

    /* "sage/arith/rational_reconstruction.pyx":74
 *         mpz_mod(v2, a, u2)             # v2 = a % m
 *         mpz_fdiv_q_2exp(bound, u2, 1)
 *         mpz_sqrtrem(bound, q, bound)   # bound = floor(sqrt(|m|/2))             # <<<<<<<<<<<<<<
 * 
...
*/
    mpz_sqrtrem(__pyx_v_bound, __pyx_v_q, __pyx_v_bound);

    /* "sage/arith/rational_reconstruction.pyx":77
 * 
 *         # Initialization: u1 = 0; v1 = 1
 *         while True:             # <<<<<<<<<<<<<<
...
*/
    while (1) {
      ...
      /* "sage/arith/rational_reconstruction.pyx":78
 *         # Initialization: u1 = 0; v1 = 1
 *         while True:
 *             if mpz_cmpabs(v2, bound) <= 0:             # <<<<<<<<<<<<<<
 *                 break
...
*/
      __pyx_t_1 = (mpz_cmpabs(__pyx_v_v2, __pyx_v_bound) <= 0);
      if (__pyx_t_1) {

        /* "sage/arith/rational_reconstruction.pyx":79
 *         while True:
 *             if mpz_cmpabs(v2, bound) <= 0:
 *                 break             # <<<<<<<<<<<<<<
 *             mpz_fdiv_q(q, u2, v2)  # q = floor(u2/v2)
...
*/
      ...
      /* "sage/arith/rational_reconstruction.pyx":80
 *             if mpz_cmpabs(v2, bound) <= 0:
 *                 break
 *             mpz_fdiv_q(q, u2, v2)  # q = floor(u2/v2)             # <<<<<<<<<<<<<<
 *             mpz_submul(u1, q, v1)  # tmp1 = u1 - q*v1   (store tmp1 in u1)
...
*/
      mpz_fdiv_q(__pyx_v_q, __pyx_v_u2, __pyx_v_v2);

      /* "sage/arith/rational_reconstruction.pyx":81
 *                 break
 *             mpz_fdiv_q(q, u2, v2)  # q = floor(u2/v2)
 *             mpz_submul(u1, q, v1)  # tmp1 = u1 - q*v1   (store tmp1 in u1)             # <<<<<<<<<<<<<<
 *             mpz_submul(u2, q, v2)  # tmp2 = u2 - q*v2   (store tmp2 in u2)
...
*/
      mpz_submul(__pyx_v_u1, __pyx_v_q, __pyx_v_v1);

      /* "sage/arith/rational_reconstruction.pyx":82
 *             mpz_fdiv_q(q, u2, v2)  # q = floor(u2/v2)
 *             mpz_submul(u1, q, v1)  # tmp1 = u1 - q*v1   (store tmp1 in u1)
 *             mpz_submul(u2, q, v2)  # tmp2 = u2 - q*v2   (store tmp2 in u2)             # <<<<<<<<<<<<<<
 *             mpz_swap(u1, v1)       # u1 = v1; v1 = tmp1
...
*/
      mpz_submul(__pyx_v_u2, __pyx_v_q, __pyx_v_v2);

      /* "sage/arith/rational_reconstruction.pyx":83
 *             mpz_submul(u1, q, v1)  # tmp1 = u1 - q*v1   (store tmp1 in u1)
 *             mpz_submul(u2, q, v2)  # tmp2 = u2 - q*v2   (store tmp2 in u2)
 *             mpz_swap(u1, v1)       # u1 = v1; v1 = tmp1             # <<<<<<<<<<<<<<
 *             mpz_swap(u2, v2)       # u2 = v2; v2 = tmp2
 * 
*/
      mpz_swap(__pyx_v_u1, __pyx_v_v1);

      /* "sage/arith/rational_reconstruction.pyx":84
 *             mpz_submul(u2, q, v2)  # tmp2 = u2 - q*v2   (store tmp2 in u2)
 *             mpz_swap(u1, v1)       # u1 = v1; v1 = tmp1
 *             mpz_swap(u2, v2)       # u2 = v2; v2 = tmp2             # <<<<<<<<<<<<<<
 * 
...
*/
      mpz_swap(__pyx_v_u2, __pyx_v_v2);
    }
    __pyx_L8_break:;

    /* "sage/arith/rational_reconstruction.pyx":87
 * 
 *         # The answer is v2/v1, but check the conditions first
 ...
 *             if mpz_cmp_ui(q, 1) == 0:
*/
    __pyx_t_1 = (mpz_cmpabs(__pyx_v_v1, __pyx_v_bound) <= 0);
    if (__pyx_t_1) {

      /* "sage/arith/rational_reconstruction.pyx":88
 *         # The answer is v2/v1, but check the conditions first
 *         if mpz_cmpabs(v1, bound) <= 0:
 *             mpz_gcd(q, v1, v2)             # <<<<<<<<<<<<<<
 *             if mpz_cmp_ui(q, 1) == 0:
...
*/
      mpz_gcd(__pyx_v_q, __pyx_v_v1, __pyx_v_v2);

      /* "sage/arith/rational_reconstruction.pyx":89
 *         if mpz_cmpabs(v1, bound) <= 0:
 *             mpz_gcd(q, v1, v2)
 *             if mpz_cmp_ui(q, 1) == 0:             # <<<<<<<<<<<<<<
 *                 # Set answer to v2/v1 with correct sign
 *                 if mpz_sgn(v1) >= 0:
*/
      __pyx_t_1 = (mpz_cmp_ui(__pyx_v_q, 1) == 0);
      if (__pyx_t_1) {

        /* "sage/arith/rational_reconstruction.pyx":91
 *             if mpz_cmp_ui(q, 1) == 0:
 *                 # Set answer to v2/v1 with correct sign
 *                 if mpz_sgn(v1) >= 0:             # <<<<<<<<<<<<<<
...
*/
        __pyx_t_1 = (mpz_sgn(__pyx_v_v1) >= 0);
        if (__pyx_t_1) {

          /* "sage/arith/rational_reconstruction.pyx":92
 *                 # Set answer to v2/v1 with correct sign
 *                 if mpz_sgn(v1) >= 0:
 *                     mpz_set(mpq_numref(answer), v2)             # <<<<<<<<<<<<<<
 *                     mpz_set(mpq_denref(answer), v1)
 *                 else:
*/
          mpz_set(mpq_numref(__pyx_v_answer), __pyx_v_v2);

          /* "sage/arith/rational_reconstruction.pyx":93
 *                 if mpz_sgn(v1) >= 0:
 *                     mpz_set(mpq_numref(answer), v2)
 *                     mpz_set(mpq_denref(answer), v1)             # <<<<<<<<<<<<<<
 *                 else:
...
*/
          mpz_set(mpq_denref(__pyx_v_answer), __pyx_v_v1);
...
*/
        ...
        /* "sage/arith/rational_reconstruction.pyx":95
 *                     mpz_set(mpq_denref(answer), v1)
 *                 else:
 *                     mpz_neg(mpq_numref(answer), v2)             # <<<<<<<<<<<<<<
...
*/
        /*else*/ {
          mpz_neg(mpq_numref(__pyx_v_answer), __pyx_v_v2);

          /* "sage/arith/rational_reconstruction.pyx":96
 *                 else:
 *                     mpz_neg(mpq_numref(answer), v2)
 *                     mpz_neg(mpq_denref(answer), v1)             # <<<<<<<<<<<<<<
 *                 sig_off()
 *                 return 0
*/
          mpz_neg(mpq_denref(__pyx_v_answer), __pyx_v_v1);
        }
        __pyx_L12:;

        /* "sage/arith/rational_reconstruction.pyx":97
 *                     mpz_neg(mpq_numref(answer), v2)
 *                     mpz_neg(mpq_denref(answer), v1)
 *                 sig_off()             # <<<<<<<<<<<<<<
 *                 return 0
...
*/
        ...
        /* "sage/arith/rational_reconstruction.pyx":98
 *                     mpz_neg(mpq_denref(answer), v1)
 *                 sig_off()
 *                 return 0             # <<<<<<<<<<<<<<
 * 
...
*/
    ...
    /* "sage/arith/rational_reconstruction.pyx":100
 *                 return 0
 * 
 *         sig_off()             # <<<<<<<<<<<<<<
...
*/
    ...
    /* "sage/arith/rational_reconstruction.pyx":107
...
*/
    ...
    __pyx_t_5 = 1;
    {
      PyObject *__pyx_callargs[2] = {__pyx_t_4, __pyx_mstate_global->__pyx_kp_u_rational_reconstruction_does_not};
  ...
  /* "sage/arith/rational_reconstruction.pyx":109
 *         raise ValueError("rational reconstruction does not exist")
 *     finally:
 *         mpz_clear(bound)             # <<<<<<<<<<<<<<
 *         mpz_clear(u1)
...
*/
  /*finally:*/ {
    ...
    /*exception exit:*/{
      ...
      {
        mpz_clear(__pyx_v_bound);

        /* "sage/arith/rational_reconstruction.pyx":110
 *     finally:
 *         mpz_clear(bound)
 *         mpz_clear(u1)             # <<<<<<<<<<<<<<
 *         mpz_clear(v1)
 *         mpz_clear(u2)
*/
        mpz_clear(__pyx_v_u1);

        /* "sage/arith/rational_reconstruction.pyx":111
 *         mpz_clear(bound)
 *         mpz_clear(u1)
 *         mpz_clear(v1)             # <<<<<<<<<<<<<<
 *         mpz_clear(u2)
 *         mpz_clear(v2)
*/
        mpz_clear(__pyx_v_v1);

        /* "sage/arith/rational_reconstruction.pyx":112
 *         mpz_clear(u1)
 *         mpz_clear(v1)
 *         mpz_clear(u2)             # <<<<<<<<<<<<<<
 *         mpz_clear(v2)
 *         mpz_clear(q)
*/
        mpz_clear(__pyx_v_u2);

        /* "sage/arith/rational_reconstruction.pyx":113
 *         mpz_clear(v1)
 *         mpz_clear(u2)
 *         mpz_clear(v2)             # <<<<<<<<<<<<<<
 *         mpz_clear(q)
*/
        mpz_clear(__pyx_v_v2);

        /* "sage/arith/rational_reconstruction.pyx":114
 *         mpz_clear(u2)
 *         mpz_clear(v2)
 *         mpz_clear(q)             # <<<<<<<<<<<<<<
*/
...
*/
  ...
  __Pyx_AddTraceback("sage.arith.rational_reconstruction.mpq_rational_reconstruction", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __pyx_r = -1;
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  return __pyx_r;
...
static int __Pyx_modinit_function_export_code(__pyx_mstatetype *__pyx_mstate) {
  ...
  if (__Pyx_ExportFunction("mpq_rational_reconstruction", (void (*)(void))__pyx_f_4sage_5arith_23rational_reconstruction_mpq_rational_reconstruction, "int (__mpq_struct *, __mpz_struct *, __mpz_struct *)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  __Pyx_RefNannyFinishContext();
  return 0;
  __pyx_L1_error:;
  __Pyx_RefNannyFinishContext();
...
static int __pyx_pymod_exec_rational_reconstruction(PyObject* module); /*proto*/
static PyModuleDef_Slot __pyx_moduledef_slots[] = {
  {Py_mod_create, (void*)__pyx_pymod_create},
  {Py_mod_exec, (void*)__pyx_pymod_exec_rational_reconstruction},
  #if CYTHON_COMPILING_IN_CPYTHON_FREETHREADING
...
__Pyx_PyMODINIT_FUNC PyInit_rational_reconstruction(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC PyInit_rational_reconstruction(void)
#if CYTHON_PEP489_MULTI_PHASE_INIT
{
...
static CYTHON_SMALL_CODE int __pyx_pymod_exec_rational_reconstruction(PyObject *__pyx_pyinit_module)
#endif
{
  ...
  if (__pyx_m) {
    ...
    PyErr_SetString(PyExc_RuntimeError, "Module 'rational_reconstruction' has already been imported. Re-initialisation is not supported.");
    return -1;
  }
  #else
  ...
  #if CYTHON_USE_MODULE_STATE
  {
    ...
    __pyx_t_1 = 0; /* transfer ownership from __pyx_t_1 to "rational_reconstruction" pseudovariable */
...
__Pyx_RefNannySetupContext("PyInit_rational_reconstruction", 0);
  ...
  if (__pyx_module_is_main_sage__arith__rational_reconstruction) {
    if (PyObject_SetAttr(__pyx_m, __pyx_mstate_global->__pyx_n_u_name, __pyx_mstate_global->__pyx_n_u_main) < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "sage.arith.rational_reconstruction")) {
      if (unlikely((PyDict_SetItemString(modules, "sage.arith.rational_reconstruction", __pyx_m) < 0))) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  /*--- Builtin init code ---*/
...
*/
  ...
  if (__pyx_m) {
    if (__pyx_mstate->__pyx_d && stringtab_initialized) {
      __Pyx_AddTraceback("init sage.arith.rational_reconstruction", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    #if !CYTHON_USE_MODULE_STATE
    Py_CLEAR(__pyx_m);
    #else
    ...
    PyErr_SetString(PyExc_ImportError, "init sage.arith.rational_reconstruction");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if CYTHON_PEP489_MULTI_PHASE_INIT
...
static const __Pyx_StringTabEntry __pyx_string_tab[] = {
  ...
  {__pyx_k_rational_reconstruction_does_not, sizeof(__pyx_k_rational_reconstruction_does_not), 0, 1, 0}, /* PyObject cname: __pyx_kp_u_rational_reconstruction_does_not */
  {__pyx_k_rational_reconstruction_with_zer, sizeof(__pyx_k_rational_reconstruction_with_zer), 0, 1, 0}, /* PyObject cname: __pyx_kp_u_rational_reconstruction_with_zer */
  {0, 0, 0, 0, 0}
};
/* InitStrings.proto */
...
static int __Pyx_InitCachedBuiltins(__pyx_mstatetype *__pyx_mstate) {
  CYTHON_UNUSED_VAR(__pyx_mstate);
  __pyx_builtin_ZeroDivisionError = __Pyx_GetBuiltinName(__pyx_mstate->__pyx_n_u_ZeroDivisionError); if (!__pyx_builtin_ZeroDivisionError) __PYX_ERR(0, 60, __pyx_L1_error)
  __pyx_builtin_ValueError = __Pyx_GetBuiltinName(__pyx_mstate->__pyx_n_u_ValueError); if (!__pyx_builtin_ValueError) __PYX_ERR(0, 107, __pyx_L1_error)
  return 0;
  __pyx_L1_error:;
  return -1;
}
